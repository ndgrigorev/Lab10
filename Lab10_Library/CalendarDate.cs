...
namespace Lab10_Library
{
    public class CalendarDate: IInit
    {
        ...
        public void Init()
        {
            ...
            do
            {
                isConvert = int.TryParse(Input("день"), out tempInt);
            } while (!isConvert);
            if (tempInt != -1)
            {
                Day = tempInt;
            ...
            do
            {
                isConvert = int.TryParse(Input("месяц"), out tempInt);
            } while (!isConvert);
            if (tempInt != -1)
            {
                Month = tempInt;
            ...
            do
            {
                isConvert = int.TryParse(Input("год"), out tempInt);
            } while (!isConvert);
            if (tempInt != -1)
            {
                Year = tempInt;
